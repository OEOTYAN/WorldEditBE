...
namespace SymHook {
    ...
    // [ԭ��] private: static class std::unordered_map<class
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> >,class SharedPtr<class BlockLegacy>,struct
    // std::hash<class std::basic_string<char,struct
    ...
    // SharedPtr<class BlockLegacy> > > > BlockTypeRegistry::mBlockLookupMap
    // [����]
    ...
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> > const & __ptr64,class
    // std::basic_string<char,struct std::char_traits<char>,class
    ...
    // [ԭ��] public: void __cdecl Level::spawnParticleEffect(class
    // std::basic_string<char,struct std::char_traits<char>,class
    ...
    // [ԭ��] void __cdecl
    // CommandUtils::displayLocalizableMessage(bool,class Player & __ptr64,class
    // std::basic_string<char,struct std::char_traits<char>,class
    ...
    // [ԭ��] public: virtual int __cdecl ServerPlayer::tickWorld(struct
    ...
    // [ԭ��] public: void __cdecl LevelChunk::tickBlocks(class BlockSource
    // &
    // __ptr64) __ptr64 [����] ?tickBlocks@LevelChunk@@QEAAXAEAVBlockSource@@@Z
    constexpr RVA
        MSSYM_B1QE10tickBlocksB1AE10LevelChunkB2AAE20QEAAXAEAVBlockSourceB3AAAA1Z =
            0x00A31630;

    // [ԭ��] public: void __cdecl LevelChunk::tickBlockEntities(class
    // BlockSource & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: void __cdecl Spawner::tick(class BlockSource &
    // __ptr64,class LevelChunk const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: bool __cdecl BlockTickingQueue::tickPendingTicks(class
    ...
    // [ԭ��] public: virtual void __cdecl Dimension::tickRedstone(void)
    // __ptr64 [����] ?tickRedstone@Dimension@@UEAAXXZ
    constexpr RVA MSSYM_B1QE12tickRedstoneB1AA9DimensionB2AAA7UEAAXXZ =
        0x00A63010;
    ...
    // [ԭ��] public: void __cdecl EntitySystems::tick(class EntityRegistry
    // &
    ...
    constexpr RVA
        MSSYM_B1QA4tickB1AE10BlockActorB2AAE20UEAAXAEAVBlockSourceB3AAAA1Z =
            0x0089D990;

    // [ԭ��] public: bool __cdecl Actor::tick(class BlockSource & __ptr64)
    // __ptr64 [����] ?tick@Actor@@QEAA_NAEAVBlockSource@@@Z
    constexpr RVA
        MSSYM_B1QA4tickB1AA5ActorB2AAA4QEAAB1UE16NAEAVBlockSourceB3AAAA1Z =
            0x00556BB0;

    // [ԭ��] public: virtual void __cdecl Actor::getDebugText(class
    // std::vector<class std::basic_string<char,struct
    // std::char_traits<char>,class std::allocator<char> >,class
    // std::allocator<class std::basic_string<char,struct
    // std::char_traits<char>,class std::allocator<char> > > > & __ptr64)
    // __ptr64 [����]
    ...
    // [ԭ��] public: virtual bool __cdecl Actor::attack(class Actor &
    // __ptr64)
    // __ptr64 [����] ?attack@Actor@@UEAA_NAEAV1@@Z
    constexpr RVA MSSYM_B1QA6attackB1AA5ActorB2AAA4UEAAB1UA6NAEAV1B2AAA1Z =
        0x00550BF0;

    // [ԭ��] public: virtual bool __cdecl Player::attack(class Actor &
    // __ptr64)
    ...
    // [ԭ��] public: virtual void __cdecl Actor::setNameTag(class
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> > const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual void __cdecl Mob::buildDebugInfo(class
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> > & __ptr64)const __ptr64 [����]
    ...
    // [ԭ��] public: class Vec3 __cdecl Actor::getViewVector(float)const
    // __ptr64 [����] ?getViewVector@Actor@@QEBA?AVVec3@@M@Z
    constexpr RVA
        MSSYM_B1QE13getViewVectorB1AA5ActorB2AAA4QEBAB1QA6AVVec3B2AAA1MB1AA1Z =
            0x005552A0;

    // [ԭ��] public: virtual class std::basic_string<char,struct
    ...
    // [ԭ��] public: virtual void __cdecl
    // ServerPlayer::setPlayerGameType(enum GameType) __ptr64 [����]
    ...
    // [ԭ��] public: class Block const & __ptr64 __cdecl
    ...
    // [ԭ��] public: class BlockLegacy const & __ptr64 __cdecl
    // Block::getLegacyBlock(void)const __ptr64 [����]
    // ?getLegacyBlock@Block@@QEBAAEBVBlockLegacy@@XZ
    constexpr RVA
        MSSYM_B1QE14getLegacyBlockB1AA5BlockB2AAE19QEBAAEBVBlockLegacyB2AAA2XZ =
            0x000BBB60;

    // [ԭ��] public: bool __cdecl BlockSource::setBlock(int,int,int,class
    // Block const & __ptr64,int) __ptr64 [����]
    ...
    // [ԭ��] public: void __cdecl BlockSource::updateNeighborsAt(class
    ...
    // [ԭ��] public: virtual enum EventResult __cdecl
    ...
    // [ԭ��] private: bool __cdecl GameMode::_destroyBlockInternal(class
    // BlockPos const & __ptr64,unsigned char) __ptr64 [����]
    ...
    // Block::toDebugString(void)const __ptr64 [����]
    ...
    // [ԭ��] public: virtual class AABB const & __ptr64 __cdecl
    // BlockLegacy::getOutline(class BlockSource & __ptr64,class BlockPos const
    // & __ptr64,class AABB & __ptr64)const __ptr64 [����]
    ...
    // [ԭ��] public: void __cdecl BlockLegacy::getDebugText(class
    // std::vector<class std::basic_string<char,struct
    // std::char_traits<char>,class std::allocator<char> >,class
    // std::allocator<class std::basic_string<char,struct
    // std::char_traits<char>,class std::allocator<char> > > > & __ptr64,class
    ...
    // [ԭ��] public: virtual void __cdecl BlockActor::getDebugText(class
    // std::vector<class std::basic_string<char,struct
    // std::char_traits<char>,class std::allocator<char> >,class
    // std::allocator<class std::basic_string<char,struct
    // std::char_traits<char>,class std::allocator<char> > > > & __ptr64,class
    ...
    // [ԭ��] public: bool __cdecl BlockSource::setExtraBlock(class BlockPos
    // const & __ptr64,class Block const & __ptr64,int) __ptr64 [����]
    ...
    constexpr RVA
        MSSYM_B2QUA4tickB1AE16HopperBlockActorB2AAE20AEAAXAEAVBlockSourceB2AAA1HB1AA1Z =
            0x008B7AA0;

    // [ԭ��] public: class Biome & __ptr64 __cdecl
    // BlockSource::getBiome(class BlockPos const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: float __cdecl Village::getApproximateRadius(void)const
    // __ptr64 [����] ?getApproximateRadius@Village@@QEBAMXZ
    constexpr RVA MSSYM_B1QE20getApproximateRadiusB1AA7VillageB2AAA7QEBAMXZ =
        0x00645380;

    // [ԭ��] public: virtual void __cdecl VillagerV2::buildDebugInfo(class
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> > & __ptr64)const __ptr64 [����]
    ...
    // [ԭ��] public: static bool __cdecl Village::isVillagePOI(class
    // BlockSource const & __ptr64,class BlockPos const & __ptr64) [����]
    ...
    // [ԭ��] public: void __cdecl VillageManager::tick(struct Tick const &
    // __ptr64) __ptr64 [����] ?tick@VillageManager@@QEAAXAEBUTick@@@Z
    constexpr RVA
        MSSYM_B1QA4tickB1AE14VillageManagerB2AAE13QEAAXAEBUTickB3AAAA1Z =
            0x00652BD0;

    // [ԭ��] public: class std::weak_ptr<class POIInstance> __cdecl
    // VillageManager::getPOI(class BlockPos const & __ptr64)const __ptr64
    // [����]
    // ?getPOI@VillageManager@@QEBA?AV?$weak_ptr@VPOIInstance@@@std@@AEBVBlockPos@@@Z
    constexpr RVA
        MSSYM_B1QA6getPOIB1AE14VillageManagerB2AAA4QEBAB1QA2AVB2QDA4weakB1UA3ptrB1AE12VPOIInstanceB3AAAA3stdB2AAE12AEBVBlockPosB3AAAA1Z =
            0x006562E0;

    // [ԭ��] public: unsigned __int64 __cdecl
    // Village::getBedPOICount(void)const __ptr64 [����]
    // ?getBedPOICount@Village@@QEBA_KXZ
    constexpr RVA MSSYM_B1QE14getBedPOICountB1AA7VillageB2AAA4QEBAB1UA3KXZ =
        0x00645420;

    // [ԭ��] public: class Mob * __ptr64 __cdecl Spawner::spawnMob(class
    // BlockSource & __ptr64,struct ActorDefinitionIdentifier const &
    // __ptr64,class Actor * __ptr64,class Vec3 const & __ptr64,bool,bool,bool)
    // __ptr64 [����]
    ...
    // [ԭ��] public: int __cdecl MobSpawnRules::getSpawnCount(class
    // SpawnConditions const & __ptr64,class BlockSource & __ptr64,class Random
    // & __ptr64,struct MobSpawnHerdInfo const & __ptr64)const __ptr64 [����]
    ...
    // [ԭ��] public: virtual class MobSpawnerData const * __ptr64 __cdecl
    ...
    // [ԭ��] public: int __cdecl
    // ActorSpawnRuleGroup::getActorSpawnPool(struct ActorDefinitionIdentifier
    ...
    // [ԭ��] private: bool __cdecl Spawner::_popCapAllows(class Dimension
    // const & __ptr64,class MobSpawnerData const & __ptr64,bool,bool)const
    // __ptr64 [����]
    ...
    // [ԭ��] private: int __cdecl Spawner::_handlePopulationCap(class
    // MobSpawnerData const * __ptr64,class SpawnConditions const & __ptr64,int)
    // __ptr64 [����]
    ...
    // [ԭ��] private: void __cdecl Spawner::_spawnStructureMob(class
    ...
    // [ԭ��] public: static bool __cdecl
    // Spawner::findNextSpawnBlockUnder(class BlockSource const & __ptr64,class
    // BlockPos & __ptr64,enum MaterialType,enum SpawnBlockRequirements) [����]
    ...
    constexpr RVA
        MSSYM_B2QUE13tryMoveInItemB1AA6HopperB2AAA4IEAAB1UE16NAEAVBlockSourceB2AAE13AEAVContainerB2AAE13AEAVItemStackB2AAA3HHHB1AA1Z =
            0x006D0120;

    // [ԭ��] public: virtual void __cdecl
    // HopperBlockActor::setItem(int,class ItemStack const & __ptr64) __ptr64
    ...
    // [ԭ��] public: bool __cdecl Item::useOn(class ItemStack &
    // __ptr64,class Actor & __ptr64,int,int,int,unsigned
    // char,float,float,float)const __ptr64 [����]
    ...
    // [ԭ��] public: class BaseCircuitComponent * __ptr64 __cdecl
    ...
    // [ԭ��] public: void __cdecl CircuitSystem::evaluate(class BlockSource
    // *
    // __ptr64) __ptr64 [����] ?evaluate@CircuitSystem@@QEAAXPEAVBlockSource@@@Z
    constexpr RVA
        MSSYM_B1QA8evaluateB1AE13CircuitSystemB2AAE20QEAAXPEAVBlockSourceB3AAAA1Z =
            0x00B93B50;

    // [ԭ��] public: virtual bool __cdecl ConsumerComponent::evaluate(class
    // CircuitSystem & __ptr64,class BlockPos const & __ptr64) __ptr64 [����]
    ...
    // TransporterComponent::evaluate(class CircuitSystem & __ptr64,class
    // BlockPos const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual bool __cdecl
    // RedstoneTorchCapacitor::evaluate(class CircuitSystem & __ptr64,class
    // BlockPos const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual void __cdecl
    // TransporterComponent::cacheValues(class CircuitSystem & __ptr64,class
    // BlockPos const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual void __cdecl
    // ComparatorCapacitor::cacheValues(class CircuitSystem & __ptr64,class
    // BlockPos const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual void __cdecl
    // RepeaterCapacitor::cacheValues(class CircuitSystem & __ptr64,class
    // BlockPos const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual void __cdecl
    // RedstoneTorchCapacitor::cacheValues(class CircuitSystem & __ptr64,class
    // BlockPos const & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] private: int __cdecl
    // RedstoneTorchCapacitor::FindStrongestStrength(class BlockPos const &
    // __ptr64,class CircuitSystem & __ptr64,bool & __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual void __cdecl Actor::setPos(class Vec3 const &
    // __ptr64) __ptr64 [����] ?setPos@Actor@@UEAAXAEBVVec3@@@Z
    constexpr RVA MSSYM_B1QA6setPosB1AA5ActorB2AAE13UEAAXAEBVVec3B3AAAA1Z =
        0x00554A20;

    // [ԭ��] private: class std::unique_ptr<class Actor,struct
    // std::default_delete<class Actor> > __cdecl
    // ActorFactory::_constructActor(struct ActorDefinitionIdentifier const &
    // __ptr64,class Vec3 const & __ptr64,class Vec2 const & __ptr64) __ptr64
    // [����]
    ...
    // [ԭ��] private: void __cdecl Core::Random::_setSeed(unsigned int)
    // __ptr64 [����] ?_setSeed@Random@Core@@AEAAXI@Z
    constexpr RVA MSSYM_B2QUA7setSeedB1AA6RandomB1AA4CoreB2AAA6AEAAXIB1AA1Z =
        0x00163ED0;

    // [ԭ��] private: unsigned int __cdecl
    // Core::Random::_genRandInt32(void)
    // __ptr64 [����] ?_genRandInt32@Random@Core@@AEAAIXZ
    constexpr RVA MSSYM_B2QUE12genRandInt32B1AA6RandomB1AA4CoreB2AAA7AEAAIXZ =
        0x001B0070;

    // [ԭ��] public: enum VanillaBiomeTypes __cdecl
    // Biome::getBiomeType(void)const __ptr64 [����]
    ...
    // [ԭ��] public: class Dimension * __ptr64 __cdecl
    ...
    // [ԭ��] public: unsigned __int64 __cdecl
    // NetworkIdentifier::getHash(void)const __ptr64 [����]
    // ?getHash@NetworkIdentifier@@QEBA_KXZ
    constexpr RVA MSSYM_B1QA7getHashB1AE17NetworkIdentifierB2AAA4QEBAB1UA3KXZ =
        0x00339FB0;

    // [ԭ��] public: virtual void __cdecl
    // ServerNetworkHandler::handle(class NetworkIdentifier const &
    // __ptr64,class CommandRequestPacket const &
    // __ptr64) __ptr64 [����]
    ...
    // [ԭ��] public: virtual class std::basic_string<char,struct
    // std::char_traits<char>,class std::allocator<char> > __cdecl
    // AutomationPlayerCommandOrigin::getName(void)const __ptr64 [����]
    ...
    // [ԭ��] public: virtual enum CommandPermissionLevel __cdecl
    // PlayerCommandOrigin::getPermissionsLevel(void)const __ptr64 [����]
    ...
    // [ԭ��] public: void __cdecl CommandRegistry::registerCommand(class
    // std::basic_string<char,struct std::char_traits<char>,class
    ...
    // [ԭ��] public: struct MCRESULT __cdecl
    // MinecraftCommands::executeCommand(class std::shared_ptr<class
    // CommandContext>,bool)const __ptr64 [����]
    ...
    // [ԭ��] public: class std::unique_ptr<class CommandContext,struct
    // std::default_delete<class CommandContext> > __cdecl
    // CommandRequestPacket::createCommandContext(class NetworkIdentifier const
    // & __ptr64,class Level & __ptr64,int)const __ptr64 [����]
    ...
    // [ԭ��] private: class std::unique_ptr<class Command,struct
    // std::default_delete<class Command> > __cdecl
    // CommandRegistry::createCommand(struct CommandRegistry::ParseToken const &
    // __ptr64,class CommandOrigin const & __ptr64,int,class
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> > & __ptr64,class std::vector<class
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> >,class std::allocator<class
    // std::basic_string<char,struct std::char_traits<char>,class
    // std::allocator<char> > > > & __ptr64)const __ptr64 [����]
    ...
    // [ԭ��] public: virtual int __cdecl StoneSlabBlock::getVariant(class
    // Block const & __ptr64)const __ptr64 [����]
    // ?getVariant@StoneSlabBlock@@UEBAHAEBVBlock@@@Z
    constexpr RVA
        MSSYM_B1QE10getVariantB1AE14StoneSlabBlockB2AAE14UEBAHAEBVBlockB3AAAA1Z =
            0x009D36D0;

    // [ԭ��] public: virtual int __cdecl WoodSlabBlock::getVariant(class
    // Block const & __ptr64)const __ptr64 [����]
    // ?getVariant@WoodSlabBlock@@UEBAHAEBVBlock@@@Z
    constexpr RVA
        MSSYM_B1QE10getVariantB1AE13WoodSlabBlockB2AAE14UEBAHAEBVBlockB3AAAA1Z =
            0x00A11720;

    // [ԭ��] public: virtual bool __cdecl
    // OceanMonumentFeature::isFeatureChunk(class BiomeSource const &
    // __ptr64,class Random & __ptr64,class ChunkPos const & __ptr64,unsigned
    // int) __ptr64 [����]
    ...
    // [ԭ��] protected: virtual bool __cdecl
    // RandomScatteredLargeFeature::isFeatureChunk(class BiomeSource const &
    // __ptr64,class Random & __ptr64,class ChunkPos const & __ptr64,unsigned
    // int) __ptr64 [����]
    ...
    // [ԭ��] public: virtual class Biome const * __ptr64 __cdecl
    // LayerBiomeSource::getBiome(int,int)const __ptr64 [����]
    ...
    // [ԭ��] public: virtual class Biome const * __ptr64 __cdecl
    // FixedBiomeSource::getBiome(int,int)const __ptr64 [����]
    // ?getBiome@FixedBiomeSource@@UEBAPEBVBiome@@HH@Z
    constexpr RVA
        MSSYM_B1QA8getBiomeB1AE16FixedBiomeSourceB2AAE13UEBAPEBVBiomeB2AAA2HHB1AA1Z =
            0x000BC3D0;

    // [ԭ��] public: class PlayerInventory & __ptr64 __cdecl
    // Player::getSupplies(void) __ptr64 [����]
    ...
    // [ԭ��] public: class ItemStack const & __ptr64 __cdecl
    // PlayerInventory::getItem(int,enum ContainerID)const __ptr64 [����]
    ...
    // [ԭ��] public: int __cdecl PlayerInventory::getContainerSize(enum
    // ContainerID)const __ptr64 [����]
    ...
    // [ԭ��] public: void __cdecl PlayerInventory::setItem(int,class
    // ItemStack const & __ptr64,enum ContainerID,bool) __ptr64 [����]
    ...
    // [ԭ��] public: virtual void __cdecl ItemStackBase::setNull(void)
    // __ptr64 [����] ?setNull@ItemStackBase@@UEAAXXZ
    constexpr RVA MSSYM_B1QA7setNullB1AE13ItemStackBaseB2AAA7UEAAXXZ =
        0x007F7D10;

    // [ԭ��] public: virtual void __cdecl FillingContainer::clearSlot(int)
    // __ptr64 [����] ?clearSlot@FillingContainer@@UEAAXH@Z
    constexpr RVA MSSYM_B1QA9clearSlotB1AE16FillingContainerB2AAA6UEAAXHB1AA1Z =
        0x0077CBB0;

    // [ԭ��] public: struct PlayerInventory::SlotData __cdecl
    // PlayerInventory::getSelectedSlot(void)const __ptr64 [����]
    ...
    // [ԭ��] public: struct Brightness __cdecl
    // BlockSource::getRawBrightness(class BlockPos const &
    // __ptr64,bool,bool)const __ptr64 [����]
    ...
    // [ԭ��] public: class Material const & __ptr64 __cdecl
    ...
    // [ԭ��] public: class LevelChunk * __ptr64 __cdecl
    // BlockSource::getChunk(class ChunkPos const & __ptr64)const __ptr64 [����]
    // ?getChunk@BlockSource@@QEBAPEAVLevelChunk@@AEBVChunkPos@@@Z
    constexpr RVA
        MSSYM_B1QA8getChunkB1AE11BlockSourceB2AAE18QEBAPEAVLevelChunkB2AAE12AEBVChunkPosB3AAAA1Z =
            0x00A15AE0;

    // [ԭ��] public: class DwellerComponent * __ptr64 __cdecl
    ...
    // [ԭ��] public: class Actor * __ptr64 __cdecl
    // Level::fetchEntity(struct ActorUniqueID,bool)const __ptr64 [����]
    ...
    // DwellerComponent::getVillageCenter(class Actor const & __ptr64)const
    // __ptr64 [����]
    ...
    // [ԭ��] public: struct Tick const & __ptr64 __cdecl
    // Level::getCurrentTick(void)const __ptr64 [����]
    ...
    // [ԭ��] public: class Block const & __ptr64 __cdecl
    // BlockPalette::getBlock(unsigned int const & __ptr64)const __ptr64 [����]
    // ?getBlock@BlockPalette@@QEBAAEBVBlock@@AEBI@Z
    constexpr RVA
        MSSYM_B1QA8getBlockB1AE12BlockPaletteB2AAE13QEBAAEBVBlockB2AAA4AEBIB1AA1Z =
            0x00A128B0;

    // [ԭ��] public: class Player * __ptr64 __cdecl
    // Dimension::fetchNearestPlayer(float,float,float,float,bool) __ptr64
    // [����] ?fetchNearestPlayer@Dimension@@QEAAPEAVPlayer@@MMMM_N@Z
    constexpr RVA
        MSSYM_B1QE18fetchNearestPlayerB1AA9DimensionB2AAE14QEAAPEAVPlayerB2AAA4MMMMB1UA1NB1AA1Z =
            0x00A64070;
    ...
    // [ԭ��] public: virtual void __cdecl Actor::die(class
    // ActorDamageSource const & __ptr64) __ptr64 [����]
    // ?die@Actor@@UEAAXAEBVActorDamageSource@@@Z
    constexpr RVA
        MSSYM_B1QA3dieB1AA5ActorB2AAE26UEAAXAEBVActorDamageSourceB3AAAA1Z =
            0x005675D0;
    ...
    // [ԭ��] private: void __cdecl
    // PistonBlockActor::_checkInceptionAchievement(class BlockActor &
    // __ptr64,class BlockSource & __ptr64,class BlockPos const & __ptr64)
    // __ptr64 [����]
    ...
    // [ԭ��] public: static void __cdecl
    // BlockTypeRegistry::forEachBlock(class std::function<bool __cdecl(class
    // BlockLegacy const & __ptr64)>) [����]

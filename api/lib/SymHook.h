...
namespace SymHook {
	...
	// [ԭ��] void __cdecl CommandUtils::displayLocalizableMessage(bool,class
	...
	// [ԭ��] public: virtual int __cdecl ServerPlayer::tickWorld(struct Tick
	...
	// [ԭ��] public: virtual bool __cdecl Actor::attack(class Actor & __ptr64)
	// __ptr64 [����] ?attack@Actor@@UEAA_NAEAV1@@Z
	constexpr RVA MSSYM_B1QA6attackB1AA5ActorB2AAA4UEAAB1UA6NAEAV1B2AAA1Z =
		0x00550BF0;

	// [ԭ��] public: virtual bool __cdecl Player::attack(class Actor & __ptr64)
	...
	// [ԭ��] public: virtual void __cdecl ServerPlayer::setPlayerGameType(enum
	// GameType) __ptr64 [����]
	...
	// [ԭ��] public: bool __cdecl BlockSource::setBlock(int,int,int,class Block
	// const & __ptr64,int) __ptr64 [����]
	...
	// [ԭ��] public: void __cdecl BlockSource::updateNeighborsAt(class BlockPos
	// const & __ptr64) __ptr64 [����]
	...
	// [ԭ��] public: class Biome & __ptr64 __cdecl BlockSource::getBiome(class
	// BlockPos const & __ptr64) __ptr64 [����]
	...
	// [ԭ��] public: int __cdecl ActorSpawnRuleGroup::getActorSpawnPool(struct
	// ActorDefinitionIdentifier const & __ptr64)const __ptr64 [����]
	...
	// [ԭ��] private: bool __cdecl Spawner::_popCapAllows(class Dimension const
	// & __ptr64,class MobSpawnerData const & __ptr64,bool,bool)const __ptr64
	// [����]
	...
	// [ԭ��] public: static bool __cdecl Spawner::findNextSpawnBlockUnder(class
	...
	// [ԭ��] public: virtual void __cdecl HopperBlockActor::setItem(int,class
	...
	// [ԭ��] public: bool __cdecl Item::useOn(class ItemStack & __ptr64,class
	...
	// [ԭ��] public: virtual bool __cdecl TransporterComponent::evaluate(class
	// CircuitSystem & __ptr64,class BlockPos const & __ptr64) __ptr64 [����]
	...
	// [ԭ��] public: virtual void __cdecl RepeaterCapacitor::cacheValues(class
	// CircuitSystem & __ptr64,class BlockPos const & __ptr64) __ptr64 [����]
	...
	// [ԭ��] private: unsigned int __cdecl Core::Random::_genRandInt32(void)
	...
	// [ԭ��] public: virtual void __cdecl ServerNetworkHandler::handle(class
	...
	// [ԭ��] public: virtual int __cdecl StoneSlabBlock::getVariant(class Block
	...
	// [ԭ��] public: virtual int __cdecl WoodSlabBlock::getVariant(class Block
	// const & __ptr64)const __ptr64 [����]
	...
	// [ԭ��] public: void __cdecl PlayerInventory::setItem(int,class ItemStack
	// const & __ptr64,enum ContainerID,bool) __ptr64 [����]
	...
	// [ԭ��] public: class Actor * __ptr64 __cdecl Level::fetchEntity(struct
	...
	// [ԭ��] public: virtual void __cdecl Actor::die(class ActorDamageSource
	// const & __ptr64) __ptr64 [����]
	...
	// [ԭ��] public: static void __cdecl BlockTypeRegistry::forEachBlock(class

...
namespace trapdoor {
    ...
    void BlockSource::setBlock(const BlockPos* blockPos, Block* block) {
        SYM_CALL(
            void (*)(void*, const BlockPos*, void*, int, void*),

...
namespace trapdoor {
    ...
    int Actor::getDimensionID() { return *(reinterpret_cast<int*>(this) + 51); }
    ...
    Level* Actor::getLevel() { return bdsMod->getLevel(); }

    std::string Actor::getActorId() {
        std::vector<std::string> info;
        SYM_CALL(void (*)(void*, std::vector<std::string>&),
                 SymHook::MSSYM_MD5_f04fad6bac034f1e861181d3580320f2, this,
                 info);
        if (info.empty())
            return "null";
